# Generated by Django 4.2.5 on 2023-09-27 00:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Big_inApp.productcategory')),
                ('seller_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='Big_inApp.sellerprofile')),
            ],
            options={
                'ordering': ['-created_at'],
            },
